...
package com.asanjay.pod.ui
{
	...
	import com.asanjay.pod.skins.PodSkin;
	 ...
	 */
	[Event(name="minimize", type="com.asanjay.pod.events.PodEvent")]
	 ...
	 *  @productversion Flex 4
	 */
	[Event(name="maximize", type="com.asanjay.pod.events.PodEvent")]
	 ...
	 *  @productversion Flex 4
	 */
	[Event(name="normal", type="com.asanjay.pod.events.PodEvent")]
	 ...
	 *  @productversion Flex 4
	 */
	[Event(name="change", type="com.asanjay.pod.events.PodEvent")]
	
	/**
	 *  Dispatched when the user closes the pod position.
	 *
	 *  @eventType com.rectius.examples.pod.events.PodWindowEvent.CHANGE
	 * 
	 *  @langversion 3.0
	 ...
	 *  @productversion Flex 4
	 */
	[Event(name="close", type="com.asanjay.pod.events.PodEvent")]
	...
	public class PodWindow extends SkinnableContainer
	{
		...
		{
			super();
			this.setStyle("skinClass",PodSkin);
		...
		public static const WINDOW_CLOSED:String = "closed";
		...
		[Inspectable(enumeration="minimized,maximized,normal,closed")]
		/**
		...
		public function set mode(value:String):void
		{
			...
			{
				_mode = value;
				dispatchEvent(new PodEvent(PodEvent.NORMAL, this));
			}
			else if(value == WINDOW_MAXIMIZED)
			{
				_mode = value;	
				dispatchEvent(new PodEvent(PodEvent.MAXIMIZE, this));
			}
			else if(value == WINDOW_MINIMIZED)
			{
				_mode = value;	
				dispatchEvent(new PodEvent(PodEvent.MINIMIZE, this));
			}
			else if(value == WINDOW_CLOSED)
			{
				_mode = value;	
				dispatchEvent(new PodEvent(PodEvent.CLOSE, this));
			}
			invalidateSkinState();
		}
		...
		{
			var dragInitiator:PodWindow = this;
		...
		protected function dragEnterHandler(event:DragEvent):void
		{
			...
			{
				DragManager.acceptDragDrop(PodWindow(event.currentTarget));
			}
		}
		...
		{
			var podEvent:PodEvent = new PodEvent(PodEvent.CHANGE,{source: event.dragInitiator , target: event.currentTarget}, true);
